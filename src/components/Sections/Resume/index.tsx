    ...
    <Section className="bg-neutral-100" sectionId={SectionId.Resume}>
      <div className="flex w-full flex-col items-center justify-center gap-y-8 py-8">
        ...
        <object
          ...
          data="/images/Alan Tai SWE Resume - 12-08.pdf" // This path now correctly points to the public folder
        >
        ...
        <a
          ...
          download="Alan Tai Resume - 10:6.pdf"
          href="/images/Alan Tai Resume - 10:6.pdf">
          Download PDF
        </a>
      </div>
    </Section>
